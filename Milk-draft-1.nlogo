...
to setup
  ...
  file-open "/Users/matthewseward/Desktop/Year 4/MILK code/an-abm-of-historic-british-milk-consumption_v1.0.0/data/netlogodata_downsampled.csv"
...
to load-value-data
  ...
  ifelse (file-exists? "/Users/matthewseward/Desktop/Year 4/MILK code/an-abm-of-historic-british-milk-consumption_v1.0.0/data/netlogovaluedata.csv")
    [set value-data []
    ;set value-data (csv:from-file "/Users/matthewgibson/OneDrive - Imperial College London/PhD/netlogovaluedata.csv")
    set value-data (csv:from-file "/Users/matthewseward/Desktop/Year 4/MILK code/an-abm-of-historic-british-milk-consumption_v1.0.0/data/netlogovaluedata.csv")
  ...
  ask turtles [
    if random-float 1 >= social-blindness and random-float 1 > 0.1 and ticks > 1 [
     ...
     ; if incum-quantity != 0 and alt-quantity != 0 [
      ...
      while [pphoat <= mmin] [set pphalt random-normal alt-physical-mean 0.1]
      while [pinoat <= mmin] [set pinalt random-normal alt-health-mean 0.1]
      while [pexoat <= mmin] [set pexalt random-normal alt-env-mean 0.1]

      while [pphsoy <= mmin] [set pphalt random-normal alt-physical-mean 0.1]
      while [pinsoy <= mmin] [set pinalt random-normal alt-health-mean 0.1]
      while [pexsoy <= mmin] [set pexalt random-normal alt-env-mean 0.1]

      while [pphalmond <= mmin] [set pphalt random-normal alt-physical-mean 0.1]
      while [pinalmond <= mmin] [set pinalt random-normal alt-health-mean 0.1]
      while [pexalmond <= mmin] [set pexalt random-normal alt-env-mean 0.1]
  ]
end
